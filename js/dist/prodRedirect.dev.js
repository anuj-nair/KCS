...
if (currHash === '#df' || currHash === '#fs' || currHash === '#i3' || currHash === '#RP' || currHash === '#bwd' || currHash === '#cac' || currHash === '#vrf' || currHash === '#CAC' || currHash === '#MRP' || currHash === '#ROS' || currHash === '#duct' || currHash === '#port' || currHash === '#vert' || currHash === '#screw' || currHash === '#cooler' || currHash === '#scroll' || currHash === '#chiller') {
